<h1 align="center"> 🚀 Validação | Input </h1>

## ✍️ Descrição
Exemplificação de Input com validação
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/validate-input.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[Publicação em Codepen](https://codepen.io/cleibp/pen/GRXZzEB) 
